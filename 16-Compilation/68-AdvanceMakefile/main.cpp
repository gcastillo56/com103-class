/* Filename: main.cpp
 *
 * This program uses the same code as our object oriented examples
 * to showcase how to create a makefile that will produce the executable
 * outside the context of an IDE
 *
 * @author: gcastill
 * August 2023
 */
