 ...
 *
 * This program showcases the use of multiple classes inherited
 * from a single parent class. Observe in the .h file how parent
 * and children classes are defined and how the accessor keywords
